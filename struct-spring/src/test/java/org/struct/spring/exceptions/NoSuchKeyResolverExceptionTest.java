...
class NoSuchKeyResolverExceptionTest {
    ...
    public void raiseException1() {
        Assertions.assertThrows(NoSuchKeyResolverException.class, () -> {
            throw new NoSuchKeyResolverException("msg");
        });
    }
    ...
    public void raiseException2() {
        Assertions.assertThrows(NoSuchKeyResolverException.class, () -> {
            throw new NoSuchKeyResolverException("msg", new NoSuchKeyResolverException());
        });
    }
    ...
    public void raiseException3() {
        Assertions.assertThrows(NoSuchKeyResolverException.class, () -> {
            throw new NoSuchKeyResolverException(new NoSuchKeyResolverException());
        });
    }
    ...
    public void raiseException4() {
        Assertions.assertThrows(NoSuchKeyResolverException.class, () -> {
            throw new NoSuchKeyResolverException("msg", new NoSuchKeyResolverException(), false, true);
        });
    }
}